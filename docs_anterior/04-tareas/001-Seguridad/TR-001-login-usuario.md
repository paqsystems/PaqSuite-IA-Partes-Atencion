...
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/001-Seguridad/SPEC-001-login-usuario.md) |
...
**Origen:** [HU](../../03-historias-usuario/001-Seguridad/HU-001-login-usuario.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/001-Seguridad/SPEC-001-login-usuario.md)
...
```gherkin
Feature: SPEC-001-login-usuario
...
- Tablas / objetos: `users`, `pq_permiso`
