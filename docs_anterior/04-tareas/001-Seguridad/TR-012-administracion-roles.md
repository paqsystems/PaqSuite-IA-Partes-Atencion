...
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/001-Seguridad/SPEC-012-administracion-roles.md) |
...
**Origen:** [HU](../../03-historias-usuario/001-Seguridad/HU-012-administracion-roles.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/001-Seguridad/SPEC-012-administracion-roles.md)
...
```gherkin
Feature: SPEC-012-administracion-roles
