...
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/001-Seguridad/SPEC-010-administracion-usuarios.md) |
...
**Origen:** [HU](../../03-historias-usuario/001-Seguridad/HU-010-administracion-usuarios.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/001-Seguridad/SPEC-010-administracion-usuarios.md)
...
```gherkin
Feature: SPEC-010-administracion-usuarios
