# TR-CTX-001 – Épica Seguridad: trazabilidad y coordinación

### 0) Tabla de metadatos

| Campo              | Valor |
|--------------------|-------|
| HU relacionada     | N/A — SPEC de contexto (`SPEC-CTX-001`) |
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/001-Seguridad/SPEC-CTX-001-seguridad-y-acceso.md) |
| Épica              | 001 – Seguridad y Acceso |
| Prioridad          | MUST-HAVE (marco) |
| Roles              | Equipo técnico |
| Dependencias       | Ver HU/SPEC; TR de seguridad base: migraciones `users`, `pq_*`. |
| Clasificación      | Contenedor |
| Última actualización | 2026-05-09 |
| Estado             | Pendiente |

**Origen:** N/A (épica de contexto; ver HU operativas en `001-Seguridad`).

**Referencia SPEC:** [SPEC](../../05-open-spec/001-Seguridad/SPEC-CTX-001-seguridad-y-acceso.md)

---

### 1) HU Refinada

Contenedor de épica **Seguridad MONO**: identidad, sesión, autorización, menú. Las TR operativas desglosan cada SPEC.
...
```gherkin
Feature: Coordinación Open-Spec
...
- Tablas / objetos: `users`, `pq_rol`, `pq_permiso`, `pq_rol_atributo`, `pq_menus`
