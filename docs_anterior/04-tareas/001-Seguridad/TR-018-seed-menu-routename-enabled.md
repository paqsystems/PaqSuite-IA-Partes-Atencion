# TR-018 – Seed pq_menus: routeName y enabled para sidebar

### 0) Tabla de metadatos

| Campo              | Valor |
|--------------------|-------|
| HU relacionada     | HU-018 – Seed pq_menus: routeName y enabled para sidebar |
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/001-Seguridad/SPEC-018-seed-menu-routename-enabled.md) |
...
**Origen:** [HU](../../03-historias-usuario/001-Seguridad/HU-018-seed-menu-routeName-enabled.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/001-Seguridad/SPEC-018-seed-menu-routename-enabled.md)
...
```gherkin
Feature: SPEC-018-seed-menu-routename-enabled
...
- Tablas / objetos: `pq_menus` + JSON seed
