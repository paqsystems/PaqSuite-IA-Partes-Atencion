...
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/001-Seguridad/SPEC-004-cambio-contrasena.md) |
...
**Origen:** [HU](../../03-historias-usuario/001-Seguridad/HU-004-cambio-contraseña.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/001-Seguridad/SPEC-004-cambio-contrasena.md)
...
```gherkin
Feature: SPEC-004-cambio-contrasena
...
- Tablas / objetos: `users.password`, `first_login`
