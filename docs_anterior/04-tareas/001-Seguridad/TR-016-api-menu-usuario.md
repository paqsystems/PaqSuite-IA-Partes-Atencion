# TR-016 – API de menú del usuario

### 0) Tabla de metadatos

| Campo              | Valor |
|--------------------|-------|
| HU relacionada     | HU-016 – API de menú del usuario |
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/001-Seguridad/SPEC-016-api-menu-usuario.md) |
...
**Origen:** [HU](../../03-historias-usuario/001-Seguridad/HU-016-api-menu-usuario.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/001-Seguridad/SPEC-016-api-menu-usuario.md)
...
```gherkin
Feature: SPEC-016-api-menu-usuario
...
- Tablas / objetos: `pq_menus` + permisos
