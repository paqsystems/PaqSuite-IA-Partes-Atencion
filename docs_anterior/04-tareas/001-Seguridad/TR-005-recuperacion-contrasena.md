...
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/001-Seguridad/SPEC-005-recuperacion-contrasena.md) |
...
**Origen:** [HU](../../03-historias-usuario/001-Seguridad/HU-005-recuperacion-contraseña.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/001-Seguridad/SPEC-005-recuperacion-contrasena.md)
...
```gherkin
Feature: SPEC-005-recuperacion-contrasena
...
- Tablas / objetos: `password_reset_tokens`
