...
| Campo              | Valor |
|--------------------|-------|
| HU relacionada     | HU-015 – Menú del sistema (seed versionado) |
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/001-Seguridad/SPEC-015-menu-sistema-seed.md) |
...
**Origen:** [HU](../../03-historias-usuario/001-Seguridad/HU-015-menu-sistema.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/001-Seguridad/SPEC-015-menu-sistema-seed.md)
...
```gherkin
Feature: SPEC-015-menu-sistema-seed
...
- Tablas / objetos: `pq_menus`; seed `docs/backend/seed/PQ_MENUS/PQ_MENUS.seed.json`
