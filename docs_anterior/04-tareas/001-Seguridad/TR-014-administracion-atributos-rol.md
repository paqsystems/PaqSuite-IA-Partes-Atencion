...
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/001-Seguridad/SPEC-014-administracion-atributos-rol.md) |
...
**Origen:** [HU](../../03-historias-usuario/001-Seguridad/HU-014-administracion-atributos-rol.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/001-Seguridad/SPEC-014-administracion-atributos-rol.md)
...
```gherkin
Feature: SPEC-014-administracion-atributos-rol
...
- Tablas / objetos: `pq_rol_atributo`
