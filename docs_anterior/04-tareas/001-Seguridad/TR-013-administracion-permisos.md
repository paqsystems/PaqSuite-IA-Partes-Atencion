...
| Campo              | Valor |
|--------------------|-------|
| HU relacionada     | HU-013 – Administración de permisos (asignaciones) |
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/001-Seguridad/SPEC-013-administracion-permisos.md) |
...
**Origen:** [HU](../../03-historias-usuario/001-Seguridad/HU-013-administracion-permisos.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/001-Seguridad/SPEC-013-administracion-permisos.md)
...
```gherkin
Feature: SPEC-013-administracion-permisos
...
- Tablas / objetos: `pq_permiso` (MONO: `id_empresa` fijo)
