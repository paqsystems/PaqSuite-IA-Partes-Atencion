# TR-017 – Sidebar dinámico desde pq_menus

### 0) Tabla de metadatos

| Campo              | Valor |
|--------------------|-------|
| HU relacionada     | HU-017 – Sidebar dinámico desde pq_menus |
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/001-Seguridad/SPEC-017-sidebar-dinamico-pqmenus.md) |
...
**Origen:** [HU](../../03-historias-usuario/001-Seguridad/HU-017-sidebar-dinamico-pqmenus.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/001-Seguridad/SPEC-017-sidebar-dinamico-pqmenus.md)
...
```gherkin
Feature: SPEC-017-sidebar-dinamico-pqmenus
