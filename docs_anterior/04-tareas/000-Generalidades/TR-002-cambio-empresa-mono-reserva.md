# TR-002 – Cambio de empresa activa (referencia MULTI; archivo HU pendiente en repo)

### 0) Tabla de metadatos

| Campo              | Valor |
|--------------------|-------|
| HU relacionada     | HU-002 – Cambio de empresa activa (referencia MULTI; archivo HU pendiente en repo) |
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/000-Generalidades/SPEC-002-cambio-empresa-multi-referencia.md) |
| Épica              | 000 – Generalidades |
| Prioridad          | N/A MONO |
| Roles              | N/A |
| Dependencias       | Ver HU/SPEC; TR de seguridad base: migraciones `users`, `pq_*`. |
| Clasificación      | Marco documental |
| Última actualización | 2026-05-09 |
| Estado             | Pendiente |

**Origen:** HU referenciada en SPEC ([enlace esperado](../../03-historias-usuario/000-Generalidades/HU-002-cambio-empresa-activa.md) — **falta el archivo en el repo**).

**Referencia SPEC:** [SPEC](../../05-open-spec/000-Generalidades/SPEC-002-cambio-empresa-multi-referencia.md)

---

### 1) HU Refinada

**In scope:** documentar que MULTI/cambio de empresa es **reserva evolutiva**, sin entrega operativa MONO. **Out of scope:** `PQ_Empresa`, `X-Company-Id`, selector de compañía.
...
```gherkin
Feature: SPEC-002-cambio-empresa-multi-referencia
...
- Tablas / objetos: Sin tablas operativas en MONO
