...
| Campo              | Valor |
|--------------------|-------|
| HU relacionada     | HU-004 – Selección de idioma de la aplicación |
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/000-Generalidades/SPEC-004-seleccion-idioma.md) |
...
**Origen:** [HU](../../03-historias-usuario/000-Generalidades/HU-004-seleccion-idioma.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/000-Generalidades/SPEC-004-seleccion-idioma.md)
...
```gherkin
Feature: SPEC-004-seleccion-idioma
