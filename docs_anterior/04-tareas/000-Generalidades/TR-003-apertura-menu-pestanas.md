...
| Campo              | Valor |
|--------------------|-------|
| HU relacionada     | HU-003 – Apertura de opción de menú en misma o nueva pestaña |
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/000-Generalidades/SPEC-003-apertura-menu-pestanas.md) |
...
**Origen:** [HU](../../03-historias-usuario/000-Generalidades/HU-003-apertura-menu-misma-o-nueva-pestana.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/000-Generalidades/SPEC-003-apertura-menu-pestanas.md)
...
```gherkin
Feature: SPEC-003-apertura-menu-pestanas
...
- Tablas / objetos: `users.menu_abrir_nueva_pestana`
