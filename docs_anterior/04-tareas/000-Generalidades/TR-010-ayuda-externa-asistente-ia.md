# TR-010 – Acceso a ayuda externa mediante chat compartido

### 0) Tabla de metadatos

| Campo              | Valor |
|--------------------|-------|
| HU relacionada     | HU-010 – Acceso a ayuda externa mediante chat compartido |
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/000-Generalidades/SPEC-010-ayuda-externa-asistente-ia.md) |
...
**Origen:** [HU](../../03-historias-usuario/000-Generalidades/HU-010-acceso-ayuda-externa-chat-compartido.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/000-Generalidades/SPEC-010-ayuda-externa-asistente-ia.md)
...
```gherkin
Feature: SPEC-010-ayuda-externa-asistente-ia
...
- Tablas / objetos: Según integración externa
