...
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/000-Generalidades/SPEC-007-parametros-generales.md) |
| Épica              | 000 – Generalidades |
| Prioridad          | MUST-HAVE |
| Roles              | Admin / operador según SPEC |
| Dependencias       | Ver HU/SPEC; TR de seguridad base: migraciones `users`, `pq_*`. |
| Clasificación      | HU COMPLEJA |
| Última actualización | 2026-05-09 |
| Estado             | Pendiente |

**Origen:** [HU](../../03-historias-usuario/000-Generalidades/HU-007-Parametros-generales.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/000-Generalidades/SPEC-007-parametros-generales.md)
...
```gherkin
Feature: SPEC-007-parametros-generales
...
- Tablas / objetos: `pq_parametros_gral`
