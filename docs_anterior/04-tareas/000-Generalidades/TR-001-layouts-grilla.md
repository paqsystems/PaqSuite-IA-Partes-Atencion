...
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/000-Generalidades/SPEC-001-layouts-grilla.md) |
...
**Origen:** [HU](../../03-historias-usuario/000-Generalidades/HU-001-layouts-grilla.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/000-Generalidades/SPEC-001-layouts-grilla.md)
...
```gherkin
Feature: SPEC-001-layouts-grilla
...
- Tablas / objetos: `pq_grid_layouts`
