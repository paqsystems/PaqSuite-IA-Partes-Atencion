# TR-008 – Multilingual con varios idiomas y banderas

### 0) Tabla de metadatos

| Campo              | Valor |
|--------------------|-------|
| HU relacionada     | HU-008 – Multilingual con varios idiomas y banderas |
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/000-Generalidades/SPEC-008-multilingual-banderas.md) |
...
**Origen:** [HU](../../03-historias-usuario/000-Generalidades/HU-008-multilingual-idiomas-banderas.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/000-Generalidades/SPEC-008-multilingual-banderas.md)
...
```gherkin
Feature: SPEC-008-multilingual-banderas
