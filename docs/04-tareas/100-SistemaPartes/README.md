...
| [TR-005](./TR-005-supervision-proceso-masivo.md) | Supervisión / proceso masivo | [HU-005](../../03-historias-usuario/100-SistemaPartes/HU-005-supervision-proceso-masivo.md) | [SPEC-005](../../05-open-spec/100-SistemaPartes/SPEC-005-supervision-proceso-masivo.md) | D hecho (F1 pendiente) |
...
1. **Parte C + C1 por cada TR** (orden 001→007): **completado** (2026-07-30).
2. Batch de ambigüedades HU ya cerrado (2026-07-30).
3. **D1:** planes en [`d1/`](./d1/) (TR-002…007).
4. **D 001→007:** implementado (2026-07-30). Siguiente: **F1** por TR; Capacitor GEN para cerrar AC-10 de TR-007.
