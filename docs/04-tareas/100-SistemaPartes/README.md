...
| [TR-007](./TR-007-mobile-capacitor.md) | Mobile Capacitor | [HU-007](../../03-historias-usuario/100-SistemaPartes/HU-007-mobile-capacitor.md) | [SPEC-007](../../05-open-spec/100-SistemaPartes/SPEC-007-mobile-capacitor.md) | Pendiente de Revisión (build/sync OK; humo manual pendiente) |
