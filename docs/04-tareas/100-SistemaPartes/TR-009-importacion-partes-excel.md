...
- Paquetes Framework vía Satis/Verdaccio (`laravel-core@^1.3.2`, `react-core@2.2.1`) exponen `ExcelImportToolbar`, handlers registry, migraciones/SP Excel y envelope `4601–4611`.
