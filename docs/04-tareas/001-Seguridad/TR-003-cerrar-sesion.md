...
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/001-Seguridad/SPEC-003-cerrar-sesion.md) |
...
**Origen:** [HU](../../03-historias-usuario/001-Seguridad/HU-003-logout.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/001-Seguridad/SPEC-003-cerrar-sesion.md)
...
```gherkin
Feature: SPEC-003-cerrar-sesion
