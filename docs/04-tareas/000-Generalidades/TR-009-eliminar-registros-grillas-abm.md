# TR-009 – Eliminar registros en grillas ABM

### 0) Tabla de metadatos

| Campo              | Valor |
|--------------------|-------|
| HU relacionada     | HU-009 – Eliminar registros en grillas ABM |
| SPEC relacionada   | [Ver SPEC](../../05-open-spec/000-Generalidades/SPEC-009-eliminar-registros-grillas-abm.md) |
| Épica              | 000 – Generalidades |
| Prioridad          | MUST-HAVE |
| Roles              | Usuario autorizado |
| Dependencias       | Ver HU/SPEC; TR de seguridad base: migraciones `users`, `pq_*`. |
| Clasificación      | HU COMPLEJA |
| Última actualización | 2026-05-09 |
| Estado             | Pendiente |

**Origen:** [HU](../../03-historias-usuario/000-Generalidades/HU-009-eliminar-registros-grillas-abm.md)

**Referencia SPEC:** [SPEC](../../05-open-spec/000-Generalidades/SPEC-009-eliminar-registros-grillas-abm.md)
...
```gherkin
Feature: SPEC-009-eliminar-registros-grillas-abm
...
- Tablas / objetos: Dominio por proceso
