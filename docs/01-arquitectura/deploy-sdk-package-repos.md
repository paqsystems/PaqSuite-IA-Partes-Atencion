...
Target: `paqsuite/laravel-core@^1.3.7` · `@paqsuite/react-core@^2.4.12` · scaffold `@paqsuite/create-app@0.1.8`
...
|------|-------------|----------|
| Backend | `paqsuite/laravel-core: ^1.3.7` | Satis `http://100.110.69.93/satis` |
| Frontend | `@paqsuite/react-core: ^2.4.12` | Verdaccio `http://100.110.69.93:4873` (`frontend/.npmrc`) |
...
- [x] Satis responde `1.3.7`; Verdaccio `2.4.12` (+ `create-app@0.1.8`)
- [ ] Locks committeados
