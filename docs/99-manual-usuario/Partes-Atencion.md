...
| **Parámetros** | Parámetros Auth, Parámetros Partes | Administradores / supervisor |
| **Soporte Técnico** | Diseñador de emisiones | Administradores / supervisor |
...
- El **diseñador de emisiones** está en Soporte Técnico → Diseñador de emisiones (escritorio; no móvil).
